...
async def me(current_user: User = Depends(get_current_user)):
    return {
        ...
        "use_ai_signal_agent": getattr(current_user, "use_ai_signal_agent", False),
        ...
        "take_profit_pct": getattr(current_user, "take_profit_pct", None),
        "trail_stop_pct": getattr(current_user, "trail_stop_pct", None),
        "use_rsi_filter": getattr(current_user, "use_rsi_filter", None),
        "use_bbands_filter": getattr(current_user, "use_bbands_filter", None),
        "use_adx_filter": getattr(current_user, "use_adx_filter", None),
        "risk_per_trade_pct": getattr(current_user, "risk_per_trade_pct", None),
        "max_exposure_pct": getattr(current_user, "max_exposure_pct", None),
    }
